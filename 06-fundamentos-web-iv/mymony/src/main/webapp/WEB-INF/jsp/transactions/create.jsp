        ...
        <form  class="form-horizontal" action="" method="POST">
            <fieldset>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="date" name="transaction.due_date" id="due_date" placehoder="Date" />
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="value">Value</label>
                    <div class="controls">
                        <input type="text" name="transaction.value" id="value" placeholder="Value" />
                    </div>
                </div>
                <div class="control-group">            
                    <label class="control-label" for="description">Description</label>
                    <div class="controls">
                        <input type="text" id="description" name="transaction.description" placeholder="Description" />            
                    </div>
                </div>
                <br />
