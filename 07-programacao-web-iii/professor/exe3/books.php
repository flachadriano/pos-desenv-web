	...
	class BookList{
		...
		public function add(Book $book){
			if (! $this->exists($book->id)){
				...
				throw new Exception("Livro com id '$book->id' jс existe.");
			} 
		}
		...
		public function edit(Book $book){
			if ($this->exists($book->id)){
				...
				throw new Exception("Livro com id '$book->id' nуo pode ser eitado porque nуo existe.");
			} 
		}
		...
		public function del($id){
			if (array_key_exists($id, $this->list)){
				...
				throw new Exception("Livro '$id' nуo existe para exluir.");
			}
		}
	}
		...
		private function restPost(){
			...
			try{
				...
				if ($book != null){
					...
					$result['status'] = 'ERROR';
					$result['message'] = 'Livro adicionado mas nуo encontrado.';
				}
		...
		private function restPut(){
			...
			try{
				...
				if ($book != null){
					...
					$result['status'] = 'ERROR';
					$result['message'] = 'Livro alterado mas nуo encontrado.';
				}
